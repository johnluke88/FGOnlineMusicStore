...
/**
 * Servlet implementation class UpdateProfiloServlet
 */
@WebServlet("/UpdateProfilo")
public class UpdateProfiloServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
    private final UserBeanDAO userBeanDAO = new UserBeanDAO();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateProfiloServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(user == null|| user.getId()!= userBeanDAO.doRetrieveByKey(Integer.parseInt(idUser)).getId())
        	throw new ExceptionServlet("Utente non loggato");
